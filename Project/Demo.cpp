...
//
//	//Create background
//	Texture* bgTexture = new Texture("example.png");
...
//
//	// load all textures for the character 
//	Texture* characterTexture1 = new Texture("Meow-Knight_Attack_1.png");
//	Texture* characterTexture2 = new Texture("Meow-Knight_Death.png");
//	Texture* characterTexture3 = new Texture("Meow-Knight_Idle.png");
//	Texture* characterTexture4 = new Texture("Meow-Knight_Jump.png");
//	Texture* characterTexture5 = new Texture("Meow-Knight_Run.png");
//	charSprite = new Sprite(characterTexture3, defaultSpriteShader, defaultQuad); // start with idle state
//	std::string characterState = "idle";
//	if (inputManager->IsKeyPressed("Attack")) {
//		characterState = "attack";
//	}
//	else if (inputManager->IsKeyPressed("Jump")) {
//		characterState = "jump";
//	}
//	else if (inputManager->IsKeyPressed("Run Right") || inputManager->IsKeyPressed("Run Left")) {
//		characterState = "run";
//	}
//	else {
//		characterState = "idle";
...
//	// Then, based on the state of your character, you can switch the texture. For example:
//	if (characterState == "attack") {
//		charSprite->SetTexture(characterTexture1);
//		charSprite->SetNumXFrames(1);
//		charSprite->SetNumYFrames(10);
//		charSprite->AddAnimation("attack", 0, 9);
//
//	}
//	else if (characterState == "death") {
//		charSprite->SetTexture(characterTexture2);
//		charSprite->SetNumXFrames(1);
//		charSprite->SetNumYFrames(6);
//		charSprite->AddAnimation("death", 0, 5);
//	}
//	else if (characterState == "idle") {
//		charSprite->SetTexture(characterTexture3);
//		charSprite->SetNumXFrames(1);
//		charSprite->SetNumYFrames(6);
//		charSprite->AddAnimation("idle", 0, 5);
//	}
//	else if (characterState == "jump") {
//		charSprite->SetTexture(characterTexture4);
//		charSprite->SetNumXFrames(1);
//		charSprite->SetNumYFrames(12);
//		charSprite->AddAnimation("jump", 0, 11);
//	}
//	else if (characterState == "run") {
//		charSprite->SetTexture(characterTexture5);
//		charSprite->SetNumXFrames(1);
//		charSprite->SetNumYFrames(8);
//		charSprite->AddAnimation("run", 0, 7);
//	}
//
//	charSprite->SetAnimationDuration(70);
//	charSprite->SetScale(2.0f);
...
//
//	// Playing music
//	music = new Music("2021-08-16_-8_Bit_Adventure-_www.FesliyanStudios.com.ogg");
//	music->SetVolume(40);
//	music->Play(true);
//
